...
from todo.views import todo_views,todo_detail_views,category_views,view_todo_in_category,logout_views,tag_views
...
urlpatterns = [
    ...
    path("categories/<slug:category_slug>/todos/<int:id>/",view_todo_in_category,name="view_todo_in_category"),
